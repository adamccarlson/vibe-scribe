...
- **Write-path (automatic):** as you work, Vibe Scribe updates the journal and overview for you — no command to remember.
- **Read-path (on demand):**
...
🚧 **Early — design phase.** See [`DESIGN.md`](./DESIGN.md) for the full design and rationale. This repo is currently a skeleton; skill and hook bodies are stubs.
